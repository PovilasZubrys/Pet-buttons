function selectOnlyThis(id) {
    ...
    for (var i = 0; i < setBackground.length; i++){
        ...
        if (id === 'Check0') {
            button.setAttribute("href", "http://www.15min.lt"); // 1 Linkas kurį kels į HTML
            ...
            button.setAttribute("href", "http://www.delfi.lt"); // 2 Linkas kurį kels į HTML
            ...
            button.setAttribute("href", "http://www.lrytas.lt"); // 3 Linkas kurį kels į HTML
