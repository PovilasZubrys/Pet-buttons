function selectOnlyThis(id) {
    ...
    for (var i = 0; i < setBackground.length; i++){
        ...
        if (id === 'Check0') {
            buttonOneTime.setAttribute("href", "http://www.15min.lt"); // 1 Linkas kurį kels į HTML
            ...
            buttonOneTime.setAttribute("href", "http://www.delfi.lt"); // 2 Linkas kurį kels į HTML
            ...
            buttonOneTime.setAttribute("href", "http://www.lrytas.lt"); // 3 Linkas kurį kels į HTML
            ...
            buttonSubscription.setAttribute("href", "http://www.facebook.com"); // 1 Linkas kurį kels į HTML
            oldPrice.textContent = "55.45$" // Sena kaina
            price.textContent = "35.95$" // Nauja kaina
            // keičia radio pasirinkimo fonus
            setBackground[0].removeAttribute("style", "background-color: #D26546; border-radius: 10px; color: white;");
            ...
            buttonSubscription.setAttribute("href", "http://www.reddit.com"); // 2 Linkas kurį kels į HTML
            oldPrice.textContent = "145.65$" // Sena kaina
            price.textContent = "99.99$" // Nauja kaina
            // keičia radio pasirinkimo fonus
            setBackground[0].removeAttribute("style", "background-color: #D26546; border-radius: 10px; color: white;");
            ...
            buttonSubscription.setAttribute("href", "http://www.google.com"); // 3 Linkas kurį kels į HTML
            oldPrice.textContent = "195.55" // Sena kaina
            price.textContent = "150.00$" // Nauja kaina
            // keičia radio pasirinkimo fonus
            setBackground[0].removeAttribute("style", "background-color: #D26546; border-radius: 10px; color: white;");
